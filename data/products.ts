...
export const products: ProductCategory[] = [
  ...
  },
  {
    ...
    subProducts: [
      {
        id: "ms-channels",
        nameKey: "products.structuralSteel.msChannels.name",
        descriptionKey: "products.structuralSteel.msChannels.description",
        image: "/products/14_ismc_100_steel_channel.png",
      },
      {
        id: "h-beams",
        nameKey: "products.structuralSteel.hBeams.name",
        descriptionKey: "products.structuralSteel.hBeams.description",
        image: "/products/13_ishb_300_steel_ibeam.png",
      },
      {
        id: "ms-angles",
        nameKey: "products.structuralSteel.msAngles.name",
        descriptionKey: "products.structuralSteel.msAngles.description",
        image: "/products/12_isa_angle_steel_100x100x10.png",
      },
      {
        id: "ms-square-pipes",
        nameKey: "products.structuralSteel.msSquarePipes.name",
        descriptionKey: "products.structuralSteel.msSquarePipes.description",
        image: "/products/10_rhs_steel_tube_100x100x6_a.png",
      },
      {
        id: "ms-round-pipes",
        nameKey: "products.structuralSteel.msRoundPipes.name",
        descriptionKey: "products.structuralSteel.msRoundPipes.description",
        image: "/products/09_ms_pipe_IS1239.png",
      },
      {
        id: "ms-flat-bars",
        nameKey: "products.structuralSteel.msFlatBars.name",
        descriptionKey: "products.structuralSteel.msFlatBars.description",
